...
class AddPersonCacheUseCase @Inject constructor(
    private val cacheRepository: CacheRepository
) {
    operator fun invoke(personDetails: PersonDetailsEntity): Flow<Response<Long>> = flow {
        try {
            val data = cacheRepository.addPerson(personDetails)
